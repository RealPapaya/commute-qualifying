...
const messages = {
  en: {
    ...
    advanced: 'Advanced', trackInfo: 'Track information', settings: 'Settings', switchToRecording: 'Switch to recording', switchToPlanning: 'Switch to planning',
    ...
    offRoute: 'YELLOW FLAG — off route', offRouteCopy: 'You left the route. Open a new route from here and keep this timer running?',
    replan: 'New route & continue', waitTrack: 'Wait for track', manualStart: 'Start early', restartRun: 'Restart',
    mapMode: 'Map mode', streetMap: 'Street map',
    cursor: 'Cursor', cursorDot: 'Dot', cursorCar: 'Car 3D', cursorRacecar: 'Race car 3D',
    cursorMotorcycle: 'Motorcycle 3D', armGps: 'ARM GPS', startRun: 'Start', abort: 'Abort', simulate: '▶ Simulate run',
    ...
    summary: 'Summary', simulated: '(sim)', dsq: 'DSQ', lap: 'Lap', records: 'records', allTracks: 'All tracks',
    closeDetails: 'Close details', detailsButton: 'DETAILS ›',
    fillGapsConfirm: 'This route has %n break(s) from paused recording. They will be auto-connected into a continuous track before saving. Continue?',
    connectingGaps: 'Connecting breaks…', gapsConnected: '%n break(s) connected.',
    recordingGapWarn: ' (%n break(s) — connected on save)',
  },
  zh: {
    traceLabel: '路線', lightsLabel: '號誌', sectorsLabel: '分段', viaLabel: '必經點',
    undoLabel: '復原', sectorLabel: '分段', trackDiagramLabel: '賽道圖',
    advanced: '進階', trackInfo: '賽道資訊', settings: '設定', switchToRecording: '改成錄製', switchToPlanning: '改成規劃',
    ...
    offRoute: '黃旗警示 — 已偏離路線', offRouteCopy: '你已經偏離路線。要不要從目前位置開闢新路線，並讓本次計時繼續？',
    replan: '開新路線並繼續', waitTrack: '等待回到路線', manualStart: '提前開始', restartRun: '重新開始',
    mapMode: '地圖模式', streetMap: '街道地圖',
    cursor: '游標', cursorDot: '圓點', cursorCar: '汽車 3D', cursorRacecar: '跑車 3D',
    cursorMotorcycle: '機車 3D', armGps: '啟動 GPS', startRun: '開始', abort: '中止', simulate: '▶ 模擬行駛',
    ...
    summary: '摘要', simulated: '（模擬）', dsq: 'DSQ', lap: '單圈', records: '筆紀錄', allTracks: '所有賽道',
    closeDetails: '關閉詳細數據', detailsButton: '詳細數據 ›',
    fillGapsConfirm: '這條路線有 %n 段斷開的路程（曾暫停錄製）。儲存前會自動接合成連續賽道，要繼續嗎？',
    connectingGaps: '接合斷點中…', gapsConnected: '已接合 %n 段斷點。',
    recordingGapWarn: '（%n 段斷開，儲存時自動接合）',
  },
};
