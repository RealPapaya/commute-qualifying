...
const messages = {
  en: {
    ...
    advanced: 'Advanced', trackInfo: 'Track information', settings: 'Settings', switchToRecording: 'Switch to recording',
  ...
  zh: {
    ...
    advanced: '進階', trackInfo: '賽道資訊', settings: '設定', switchToRecording: '改成錄製',
